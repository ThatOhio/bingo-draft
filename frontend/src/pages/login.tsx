...
function Login() {
	...
	const handleDiscordLogin = () => {
		setLoading(true)
		loginWithDiscord(eventCode || undefined)
	}
				...
				<div className="max-w-md w-full space-y-8">
					<div>
						...
						<p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
							Use your Discord account to access the draft platform
						</p>
					</div>
					{error && (
					...
					<div className="text-center">
						<Link to="/" className="text-sm text-indigo-600 dark:text-indigo-400 hover:text-indigo-500 dark:hover:text-indigo-300">
							Back to home
						</Link>
					</div>
				</div>
